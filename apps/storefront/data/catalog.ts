...
export type Product={id:string;offerId?:string;productId?:string;name:string;image:string;category:string;categorySlug?:string;rating:number;reviewCount:number;priceMode:PriceMode;originalPrice:number;discountPercent?:number;price:number;badge:string;stock:number;isFastDelivery?:boolean;isFreeShipping?:boolean;hasDiscount?:boolean;gallery?:string[];variants?:{id:string;label:string;price:number;stock:number}[];sellerName?:string;description?:string;variantLabel?:string};
