...
import { AdminProductImports } from "./admin-product-imports";
import { AdminMerchandising } from "./admin-merchandising";
import { AdminAds } from "./admin-ads";
import { AdminMobileSettings } from "./admin-mobile-settings";
...
export function SectionContent({ section }: { section: AdminSection }) {
  ...
  if (section.id === "orders") return <><AdminOrders /><AdminOrderRequests /><AdminOrderOperations /></>;
  ...
  if (section.id === "documents") return <AdminDocuments />;
  if (section.id === "top-seo-pages") return <AdminSeoSettings />;
  if (section.id === "product-imports") return <AdminProductImports />;
  if (section.id === "top-product-ranking") return <AdminMerchandising mode="ranking" />;
  if (section.id === "top-filter-standard") return <AdminMerchandising mode="filter" />;
  if (section.id === "top-ads") return <AdminAds />;
  if (section.id === "top-mobile-settings") return <AdminMobileSettings />;
