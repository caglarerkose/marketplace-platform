...
export function AdminProductApprovals() {
  ...
  return <>
    <div className="page-head"><div className="page-title"><h1>Ürün Onayları </h1><p>Satıcılardan gelen ürün kartlarını, varyantları ve mağaza tekliflerini değerlendirin.</p></div><button className="btn" onClick={() => void load()}><i className="fa-solid fa-rotate" /> Yenile</button></div>
